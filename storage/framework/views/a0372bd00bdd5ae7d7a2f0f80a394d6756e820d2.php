        ...
        <table width="100%">
            <tr>
                <td width="10%" align="center">
                    <img src="<?php echo e(asset('image-inject/dkijkt.jpg')); ?>" alt="" width="100px" height="75px">
                </td>
                ...
                <td width="10%" align="center">
                    <img src="<?php echo e(asset('image-inject/logomri.png')); ?>" alt="" width="100px" height="75px">
                </td>
            </tr>
        </table>
        <br>
                ...
                <ul class="list-group">
                    <li class="list-group-item active">
                        ...
                        <p>
                            ...
                            Jam : <?php echo e(date("H:i:s")); ?> <br>

                            Nomor Pesanan : <?php echo e($data->number_order); ?> <br>
                            Nomor Meja : <?php echo e($data->number_table_rel); ?> <br>
                            Status : <?php if($data->status_order == "Open"): ?>
                                         Open
                        ...
                        <table class="table w-100">
                            ...
                            <?php $__currentLoopData = $get_dataorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->rendome_booking_order); ?></td>
                                    <td><?php echo e($item->name_menu_order); ?></td>
                                    <td><?php echo e($item->name_qty_order); ?></td>
                                </tr>
...
<?php /**PATH C:\laragon\www\e-booking\resources\views/pdf/pdf_struk_paper.blade.php ENDPATH**/ ?>