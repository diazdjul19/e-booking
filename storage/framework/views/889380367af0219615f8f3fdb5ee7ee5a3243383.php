...
<html>
    ...
    <div class="login-logo">
        <a href="#"><b>E-</b>Booking</a>
    </div>

    
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg" style="font-weight: bold; color:black; font-size:15px;">Sign in to E-Booking Dashboard</p>
...
<?php /**PATH C:\laragon\www\e-booking\resources\views/auth/login.blade.php ENDPATH**/ ?>