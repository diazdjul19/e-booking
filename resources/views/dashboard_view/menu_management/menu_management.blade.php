            ...
            <div class="modal fade" id="modal-create">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{route('menu-management.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td style="min-width:100px; text-align:center;">
                                            @if($d->foto_menu)
                                                <a href="{{url('/storage/foto_menu/'.$d->foto_menu)}}" data-toggle="lightbox" data-type="image" data-footer="Foto Menu : {{$d->name_menu}}">
                                                    <img src="{{url('/storage/foto_menu/'.$d->foto_menu)}}" style="width: 50px; max-height:50px; border-radius:5px;">
                                                </a>
                                            @endif
                                        </td>
                                        <td style="min-width:100px;" class="">{{$d->name_menu}}</td>
                                        <td style="min-width:100px;" class="text-center">{{$d->type_menu}}</td>
                                        <td style="min-width:100px; text-align:center;">Rp. {{number_format($d->price_menu,0, ".", ".")}}</td>
                                        <td style="min-width:100px;" class="text-center">{{$d->status_menu}}</td>
                                        <td style="min-width:100px;" style="padding-top: 15px;" class="text-center">
                                            ...
                                            <a href="{{route('menu-management-delete', $d->id)}}" id="" class="delete-alert btn btn-danger btn-xs"  style="margin: 3px;"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
